...
exports.config = {
     ...
     */
     before: function (capabilities, specs) {
        ...
        browser.addCommand('waitAndSelectAttribute', function(attribute, text) {
            try{
                $(selector).waitForExist()
                $(selector).selectByAttribute(attribute, text)
            }
            catch(error){
                throw new Error(`Could not select attribute: ${attribute}`)
            }
        })
